...
void Renderer::MainMenu(sf::RenderWindow& window, bool& isPlaying)
{
    ...
    m_LogInText.setFont(assets->font);
    ...
    m_RegisterText.setFont(assets->font);
...
{
    sf::Text errorMessage(message, assets->font, 24);
...
{
    m_background.setTexture(assets->background);
